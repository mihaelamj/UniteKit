...
extension UKFontWeight: CustomStringConvertible {
...
extension UKFont {
  public static func systemFontOfSize(_ fontSize: CGFloat, weight: UKFontWeight) -> UKFont {
    #if os(iOS) || os(tvOS) || os(watchOS)
    return UKFont.systemFont(ofSize: fontSize, weight: UIFont.Weight(rawValue: weight.weight))
    #else
